...
db.serialize(() => {
    ...
    db.run("CREATE TABLE SEND_TRANSACTION (STid INT PRIMARY KEY NOT NULL, Amount INT NOT NULL, Date TEXT, Memo TEXT, Cancelled INT, SSN INT, Identifier TEXT,FOREIGN KEY(SSN) REFERENCES USER_ACCOUNT(SSN), FOREIGN KEY(Identifier) REFERENCES ELECTRONIC_ADDRESS(Identifier))");
    db.run("CREATE TABLE REQUEST_TRANSACTION (RTid INT PRIMARY KEY NOT NULL, Amount INT NOT NULL, Date TEXT, Memo TEXT, SSN INT, FOREIGN KEY(SSN) REFERENCES USER_ACCOUNT(SSN))");
    ...
    db.run("INSERT INTO REQUEST_TRANSACTION VALUES (1,20,'Jan 7','owe me',123456789)");
    db.run("INSERT INTO REQUEST_TRANSACTION VALUES (2,20,'Jan 8','here',123456789)");
    db.run("INSERT INTO REQUEST_TRANSACTION VALUES (3,30,'Jan 9','test',123456789)");

    db.run("INSERT INTO SEND_TRANSACTION VALUES (1,20,'Jan 5','hello',1,123456789,'6096133150')");
    db.run("INSERT INTO SEND_TRANSACTION VALUES (2,200,'Jan 5','greetings',0,123456789,'6096133150')");
    db.run("INSERT INTO SEND_TRANSACTION VALUES (3,300,'Jan 6','njit',0,123456789,'6096133150')");
