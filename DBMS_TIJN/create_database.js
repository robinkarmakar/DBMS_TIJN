...
db.serialize(() => {
    ...
    db.run("CREATE TABLE SEND_TRANSACTION (STid INTEGER PRIMARY KEY AUTOINCREMENT, Amount INT NOT NULL, Date TEXT, Memo TEXT, Cancelled INT, SSN INT, Identifier TEXT,FOREIGN KEY(SSN) REFERENCES USER_ACCOUNT(SSN), FOREIGN KEY(Identifier) REFERENCES ELECTRONIC_ADDRESS(Identifier))");
    ...
    db.run("INSERT INTO SEND_TRANSACTION(Amount,Date,Memo,cancelled,SSN,Identifier) VALUES (20,'Jan 5','hello',1,123456789,'6096133150')");
    db.run("INSERT INTO SEND_TRANSACTION(Amount,Date,Memo,cancelled,SSN,Identifier) VALUES (200,'Jan 5','greetings',0,123456789,'6096133150')");
    db.run("INSERT INTO SEND_TRANSACTION(Amount,Date,Memo,cancelled,SSN,Identifier) VALUES (300,'Jan 6','njit',0,123456789,'6096133150')");
